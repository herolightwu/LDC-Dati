package com.epasaule.bluetoothutillib.handlers;
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            case MESSAGE_READ:
                ...
                String readMessage = new String(readBuf, 0, datalength).trim();
                if (readMessage.startsWith("1000000")) {
                    readMessage = readMessage.replaceFirst("1000000", "");
                }
                if(readBuf.length > 0) {
                    if(mListener != null)
